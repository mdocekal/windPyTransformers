...
setup_args = dict(
    ...
    install_requires=[
        'windpyutils @ git+git://github.com/windionleaf/windPyUtils.git#windpyutils',
        'windpytorchutils @ git+git://github.com/windionleaf/windPyTransformers.git#windpytorchutils',
        'tqdm>=4.41.1',
        'torch>=1.3.1',
        'apex==0.1',
        'transformers>=2.3.0'
